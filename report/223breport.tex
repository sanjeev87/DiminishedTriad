...
The Sentinel itself is designed to run in a configuration where there are multiple Sentinel processes cooperating together. We have not used configured our Sentinel to work this way but this can be accomplished with minor configuration modifications. This makes the Sentinel fault tolerant to failures. 


\subsection{Handling Failures and Data Redistribution}


\subsection{Handling New Joins and Data Redistribution}
