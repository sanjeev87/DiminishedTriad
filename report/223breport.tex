...
\begin{enumerate}
  ...
  \item DTClient - The DTClient is the only channel of communication with the Redis Backend. All requests received by the DTServer
  \item DTInstance - asfadsfas
  \item Redis Backend - asdfasdf
  \item DTClientAPI - 
  \item DTServerAPI - 
\end{enumerate}
