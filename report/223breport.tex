...
\subsection{Hashing Keys, the Master and the Chord Ring}
The Chord ring has N positions in it. Every node hosting a DTInstance and a Redis backend is hashed to one of these N positions. 
